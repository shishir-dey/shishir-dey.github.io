        ...
        <div className={`min-h-screen transition-colors duration-200 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-800'
            ...
            <header className="sticky top-0 z-40 backdrop-blur-md bg-opacity-90 shadow-xs">
                <div className="max-w-6xl mx-auto px-4 py-4">
                    ...
                    {/* Tag Filter */}
                    <div className="flex overflow-x-auto gap-2 mb-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                        {allTags.map((tag) => (
                            <button
                                key={tag}
                                ...
                                className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium transition-colors duration-200 whitespace-nowrap ${selectedTags.includes(tag)
